...
void MainWindow::createActions() {
  ...
  connect(recalculateAction, &QAction::triggered, spreadsheet,
  ...
  showGridAction->setStatusTip(tr("Show or hide the spreadsheet's "
                                  "grid"));
  connect(showGridAction, &QAction::toggled, spreadsheet,
          &Spreadsheet::setShowGrid);
#if QT_VERSION < 0x040102
  // workaround for a QTableWidget bug in Qt 4.1.1
  connect(showGridAction, &QAction::toggled, spreadsheet->viewport(),
          &Spreadsheeet::update);
#endif
  ...
  connect(autoRecalcAction, &QAction::toggled, spreadsheet,
          &Spreadsheet::setAutoRecalculate);
...
void MainWindow::createStatusBar() {
  ...
  connect(spreadsheet, &Spreadsheet::currentCellChanged, this,
          &MainWindow::updateStatusBar);
  connect(spreadsheet, &Spreadsheet::modified, this,
